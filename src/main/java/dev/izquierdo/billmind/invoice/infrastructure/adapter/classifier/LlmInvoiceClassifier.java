...
public class LlmInvoiceClassifier {
    ...
    /**
     * Joins consecutive short tokens (≤2 chars) by removing the space between them.
     * Fixes PDFs where header text is fragmented character by character,
     * e.g. "En de sa E ne rg ía , S .A" should read "EndesaEnergía,S.A".
     * Applied only on the preview (150-200 chars) where fragmentation is detectable.
     */
